...
void FileOps::parse(string argument){
    ...
    //Last part of argument (quantum) is parsed.
        ...
        //NOTE: will have to change later between shortfifo & fifo
        else{
            readFile(file);
...
//Reads the file line by line, then does it each by tab. It then fills queue (which should've already been created by a call in the parse function)
        ...
        //Read file line by line
            ...
            while(getline(openfile, line)){
                ...
                if(line.at(0) == '#'){
                    ...
                    //So... Have to check again by schedule. This isn't very efficient but it'll have to do for now.
                    if(schedule == "roundrobin"){
