...
//PreCondition: size has been passed from the appropriate schedule class (ie which schedule type was parsed from the argument) and a circular queue is created
